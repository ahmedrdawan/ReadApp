    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FaviorateBooks", x => new { x.UserId, x.BookId });
                    table.ForeignKey(
                        name: "FK_FaviorateBooks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FaviorateBooks_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FaviorateBooks_BookId",
                table: "FaviorateBooks",
                column: "BookId");
